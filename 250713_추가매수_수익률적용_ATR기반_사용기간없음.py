...
BASE_ADD_BUY_DROP = 0.90  # 기본 추가 매수 하락률 (5% 하락하면 추가 매수)
...
def adjust_buy_drop_based_on_atr(atr_percent):
    ...
    if atr_percent > 12:  
        return BASE_ADD_BUY_DROP * 0.85   # 변동성 급등락 때 (0.90는 10% 하락 추가 매수)
    elif atr_percent < 3:  
        return BASE_ADD_BUY_DROP * 0.95   # 변동성 작을 때 (0.98는 2% 하락 추가 매수)
